...
**Live Deployment:** [https://arl-batch-tracker.onrender.com](https://arl-batch-tracker.onrender.com)
...
```bash
git clone https://github.com/Zubairr3/ARL-Batch-Tracker.git
...
**Why this holds behind a load balancer:**
